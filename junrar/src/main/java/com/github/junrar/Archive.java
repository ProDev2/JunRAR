...
public class Archive implements Closeable, Iterable<FileHeader> {
    ...
    public Archive(
        ...
        try {
            ...
            try {
                ...
                Log.e(TAG, "Failed to close the archive after an internal error!");
            }
            throw e;
    ...
    private void setFile(final IReadOnlyAccess file, final long length) throws IOException, RarException {
        ...
        try {
            ...
            Log.w(TAG, "exception in archive constructor maybe file is encrypted, corrupt or support not yet implemented", e);
                ...
                case MarkHeader:
                    ...
                    if (!this.markHead.isSignature()) {
                        if (markHead.getVersion() == RARVersion.V5) {
                            Log.w(TAG, "Support for rar version 5 is not yet implemented!");
